...
export function decisionCardFromBriefItem(item: BriefItem): DecisionCard {
  ...
  return {
    ...
    action:
      item.recommended_action ?? "Review the evidence before choosing a move.",
...
export function decisionCardFromOpportunity(
  ...
  return {
    ...
    timing:
      item.calendar_escalation_label ?? "Review before the next market window.",
    ...
    risk:
      ...
      "The market may close before the thesis is confirmed.",
