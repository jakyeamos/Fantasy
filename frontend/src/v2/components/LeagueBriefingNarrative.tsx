...
export function LeagueBriefingNarrative({
  ...
  const band = confidence === "high" || confidence === "medium" ? confidence : "low"
  ...
  const card: DecisionCardModel = {
    ...
    urgency: lineup?.title_window_label === "Peak Window" ? "this_week" : "watch",
    confidence: {
      band,
  ...
  return (
    <section aria-labelledby="league-briefing-narrative" className="space-y-4">
      <div>
        ...
        <h2 id="league-briefing-narrative" className="mt-2 font-headline text-2xl font-extrabold">
