    ...
    <div className="space-y-8">
      <section className="space-y-3 border-b border-border/45 pb-8">
        ...
        <p className="max-w-3xl text-sm leading-6 text-muted-foreground">
          Each workspace keeps direction, lineup gaps, roster hygiene, market, and league operations
          in one context. The global shell stays data-free; this destination owns the league read.
        </p>
      </section>
            ...
            <Card key={league.league_id} className="flex flex-col">
              <CardHeader className="flex-1">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    ...
                    <CardTitle className="mt-2 text-2xl">{league.league_name}</CardTitle>
                  </div>
                  <Badge variant={league.confidence_band === "High" ? "secondary" : "outline"}>
              ...
              <CardContent className="space-y-3 border-t border-border/40 pt-4">
                ...
                <Link
                  ...
                  search={league.user_roster_id ? { rosterId: league.user_roster_id } : undefined}
