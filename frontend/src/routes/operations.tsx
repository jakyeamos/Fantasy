    ...
    <div className="space-y-8">
      <section className="space-y-3 border-b border-border/45 pb-8">
        ...
        <p className="max-w-3xl text-sm leading-6 text-muted-foreground">
          Process health, schema readiness, source freshness, and per-league
          data health are separate facts. A green process probe never
          substitutes for fresh league evidence.
        </p>
      </section>
      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-sm leading-6 text-muted-foreground">
          <p>
            Refreshes write only to the configured local DuckDB. Migration
            rehearsal uses a copied database and a restore manifest. External
            league actions remain manual and outside this app boundary.
          </p>
          <p>
            For a blocked migration, preserve the legacy database and restart on
            the legacy branch; do not silently repair or drop tables at startup.
          </p>
        </CardContent>
      </Card>
    </div>
