...
export function StrategicDistinctionBanner({ distinction }: { distinction: StrategicDistinction }) {
  ...
  return (
    <div
      className={`glass-panel flex items-start gap-3 rounded-xl border p-5 ${
        isNeutral ? "border-border/45 bg-card/50" : "border-primary/25 bg-primary/10"
      }`}
    >
