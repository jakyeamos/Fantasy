"""Add fresh intelligence, league impact, and morning brief truth."""

from __future__ import annotations

from alembic import op

revision = "025_fresh_intelligence"
...
def upgrade() -> None:
    ...
    op.execute(
        ...
        CREATE TABLE IF NOT EXISTS league_impacts (
            ...
            computed_at       TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
            UNIQUE (
                event_id, league_id, roster_id, impact_type,
                affected_asset_ids_json, model_version
            )
        )
        """
    )
