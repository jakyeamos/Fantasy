"""Repair fresh-intelligence tables missing from databases stamped at head."""
...
revision = "030_repair_fresh_intelligence_schema"
down_revision = "029_repair_freshness_domain_columns"
branch_labels = None
depends_on = None


def upgrade() -> None:
    """Create the fresh-intelligence tables when an older head skipped them."""
    ...
    for statement in (
        ...
        CREATE TABLE IF NOT EXISTS intelligence_source_runs (
            ...
            source_outcomes_json VARCHAR NOT NULL DEFAULT '[]',
        ...
        CREATE TABLE IF NOT EXISTS source_observations (
            ...
            model_extracted BOOLEAN NOT NULL DEFAULT FALSE,
        ...
        CREATE TABLE IF NOT EXISTS event_reviews (
            ...
            notes VARCHAR,
            reviewed_by VARCHAR NOT NULL DEFAULT 'user',
        ...
        CREATE TABLE IF NOT EXISTS canonical_player_projections (
            ...
            availability_before VARCHAR,
            availability_after VARCHAR,
            role_before DOUBLE,
            role_after DOUBLE,
            value_before DOUBLE NOT NULL,
            value_after DOUBLE NOT NULL,
            delta_json VARCHAR NOT NULL DEFAULT '{}',
            confidence DOUBLE NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS league_impacts (
            ...
            affected_asset_ids_json VARCHAR NOT NULL DEFAULT '[]',
            headline VARCHAR NOT NULL,
            explanation VARCHAR NOT NULL,
            before_json VARCHAR NOT NULL DEFAULT '{}',
            after_json VARCHAR NOT NULL DEFAULT '{}',
            deltas_json VARCHAR NOT NULL DEFAULT '{}',
            confidence DOUBLE NOT NULL,
            actionable BOOLEAN NOT NULL DEFAULT FALSE,
            recommended_action VARCHAR,
            cta_label VARCHAR,
            cta_destination VARCHAR,
            invalidation VARCHAR NOT NULL,
            model_version VARCHAR NOT NULL,
            computed_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
        )
        ...
        CREATE TABLE IF NOT EXISTS daily_briefs (
            ...
            run_id VARCHAR NOT NULL,
            status VARCHAR NOT NULL,
            source_health_json VARCHAR NOT NULL DEFAULT '[]',
            created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
        ...
        CREATE TABLE IF NOT EXISTS daily_brief_items (
            ...
            recommended_action VARCHAR,
            confidence DOUBLE NOT NULL,
            source_summary VARCHAR NOT NULL,
            invalidation VARCHAR NOT NULL,
            impact_json VARCHAR NOT NULL DEFAULT '{}',
            cta_label VARCHAR,
            cta_destination VARCHAR,
            created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
        )
...
def downgrade() -> None:
    """Leave shared tables intact when rolling back the repair marker."""
